...
STDOUT_FILE=$LOGS_DIR/AiBridge.log

CURRENT_DATE=`date '+%Y-%m-%d'`
STDERR_FILE=$LOGS_DIR/stderr_AiBridge.log.$CURRENT_DATE
...
echo -e "Starting the AiBridge ...\c"
nohup java $JAVA_OPTS $JAVA_MEM_OPTS $JAVA_DEBUG_OPTS $JAVA_JMX_OPTS -classpath $CONF_DIR:$LIB_JARS com.yunqiao.server.App > /dev/null 2>>$STDERR_FILE &
